...
@NamedQueries({
    ...
    , @NamedQuery(name = "ProductCategoryProduct.findByCategoryid", query = "SELECT p FROM ProductCategoryProduct p WHERE p.productCategoryProductPK.categoryid = :categoryid")
