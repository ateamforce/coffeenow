...
<html lang="en">
	...
	<head>
		...
		<meta property="og:url" content='<tiles:insertAttribute name="ogUrl" />' />
		<meta property="og:type" content="website" />
		<meta property="og:image" content='<tiles:insertAttribute name="ogImageUrl" />' />
		<meta property="og:image:width" content='<tiles:insertAttribute name="ogImageWidth" />' />
		<meta property="og:image:height" content='<tiles:insertAttribute name="ogImageHeight" />' />
		<meta property="og:image:type" content="image/jpeg" />
		<meta name="description" content='<tiles:insertAttribute name="pageDescription" />'>
