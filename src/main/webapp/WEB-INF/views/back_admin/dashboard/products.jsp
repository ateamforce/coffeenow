						...
						<table data-cfn-delUrl="administrator/dashboard/products/delete/"
							...
							<thead>
								<tr>
									...
									<th class="descriptionHeaderCFN"><spring:message code="thisDescription" /></th>
							...
							<tfoot>
								<tr>
									...
									<th><spring:message code="thisDescription" /></th>
									<th><spring:message code="admin.menu.productcategories" /></th>
									...
									<tr>
										...
										<td class="rowImageCFN">
											<c:if test="${product.hasimage == true}">
												<c:set var="thisImage"><%= resource.getString("front.images.products.items") %>${product.id}.jpg</c:set>
													<img src="img/product/${cache:bustImage(thisImage, realPath)}" />
											</c:if>
										</td>
										<td>
