                        ...
                        <table data-cfn-delUrl="administrator/dashboard/extracategories/delete/" data-cfn-getOneUrl="administrator/dashboard/extracategories/" class="table table-bordered responsive no-wrap" id="mainCategoriesTableCFN" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="titleHeaderCFN"><spring:message code="thisTitle" /></th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="rowImageCFN">
                                            <c:if test="${extraCategory.hasimage == true}">
												<c:set var="thisImage"><%= resource.getString("front.images.extras.categories") %>${extraCategory.id}.jpg</c:set>
													<img src="img/extra/category/${cache:bustImage(thisImage, realPath)}" />
                                            </c:if>
                                        </td>
                                        <td>
